...
import BedAvailability from "./diagram/BedAvailability";
import UsageBedCard from "./diagram/UsageBedCard";
import TopDiagnosa from "./diagram/TopDiagnosa";
...
const Contents = () => {
  return (
    <div className="flex-1 m-3 rounded bg-[#04ac49]/10 rounded">
      ...
      {/* Widget 5 */}
      <div className="widget-5 ml-8 mt-12 flex flex-row text-left">
        ...
        <div className="right font-bold h-10 grow pl-8">
